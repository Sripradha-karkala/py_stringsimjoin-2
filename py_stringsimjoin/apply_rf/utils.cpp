...
#endif
{
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "jaccard_using_overlap", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_13sim_functions_jaccard_using_overlap, "double (int const &, int const &, double const &)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_1, "dice_using_overlap", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_13sim_functions_dice_using_overlap, "double (int const &, int const &, double const &)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_1, "cosine_using_overlap", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_13sim_functions_cosine_using_overlap, "double (int const &, int const &, double const &)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_1, "overlap_coeff_using_overlap", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_13sim_functions_overlap_coeff_using_overlap, "double (int const &, int const &, double const &)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
