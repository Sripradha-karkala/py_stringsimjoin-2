...
static void __pyx_f_16py_stringsimjoin_8apply_rf_24overlap_coefficient_join_build_inverted_index(std::vector<std::vector<int> >  &, InvertedIndex &); /*proto*/
...
/* "py_stringsimjoin/apply_rf/overlap_coefficient_join.pyx":12
 * 
 * 
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/overlap_coefficient_join.pyx":18
 *     cdef vector[vector[pair[int, int]]] output_pairs
 *     cdef vector[pair[int, int]] partitions, final_output_pairs, part_pairs
 ...
 */
  __pyx_f_16py_stringsimjoin_8apply_rf_24overlap_coefficient_join_build_inverted_index(__pyx_v_ltokens, __pyx_v_index);
 ...
 */
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_partition_size); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_3 = 0;
  if (__Pyx_Print(0, __pyx_t_2, 1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
    ...
    __pyx_t_2 = 0;
    __pyx_t_3 = 0;
    if (__Pyx_Print(0, __pyx_t_1, 1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pw_16py_stringsimjoin_8apply_rf_24overlap_coefficient_join_1ov_coeff_join(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("ov_coeff_join (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_rtokens)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("ov_coeff_join", 1, 3, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_threshold)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ov_coeff_join", 1, 3, 3, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "ov_coeff_join") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_ltokens = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_int_3e___(values[0]); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  ...
  __Pyx_RaiseArgtupleInvalid("ov_coeff_join", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
...
static void __pyx_f_16py_stringsimjoin_8apply_rf_24overlap_coefficient_join_ov_coeff_join_part(std::pair<int,int>  __pyx_v_partition, CYTHON_UNUSED std::vector<std::vector<int> >  &__pyx_v_ltokens, std::vector<std::vector<int> >  &__pyx_v_rtokens, double __pyx_v_threshold, InvertedIndex &__pyx_v_index, std::vector<std::pair<int,int> >  &__pyx_v_output_pairs) {
  ...
  /* "py_stringsimjoin/apply_rf/overlap_coefficient_join.pyx":52
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "py_stringsimjoin/apply_rf/overlap_coefficient_join.pyx":60
 * 
 *         for j in range(m):
 *             candidates = index.index[tokens[j]]             # <<<<<<<<<<<<<<
 *             for cand in candidates:
 ...
 */
    ...
    for (;;) {
      ...
      /* "py_stringsimjoin/apply_rf/overlap_coefficient_join.pyx":66
 * #        print i, candidate_overlap.size()
 *         for entry in candidate_overlap:
 *             sim_score = <double>entry.second / <double>int_min(m, index.size_vector[entry.first])             # <<<<<<<<<<<<<<
 *             #print ltokens[entry.first], rtokens[i], entry.second, sim_score
...
static void __pyx_f_16py_stringsimjoin_8apply_rf_24overlap_coefficient_join_build_inverted_index(std::vector<std::vector<int> >  &__pyx_v_token_vectors, InvertedIndex &__pyx_v_inv_index) {
  std::vector<int>  __pyx_v_tokens;
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/overlap_coefficient_join.pyx":79
 *         tokens = token_vectors[i]
 *         m = tokens.size()
 *         size_vector.push_back(m)             # <<<<<<<<<<<<<<
 *         for j in range(m):
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("py_stringsimjoin.apply_rf.overlap_coefficient_join.build_inverted_index", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
