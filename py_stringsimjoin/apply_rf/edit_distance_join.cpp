 ...
 */
  ...
  __Pyx_WriteUnraisable("py_stringsimjoin.apply_rf.edit_distance_join.ed_join", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("py_stringsimjoin.apply_rf.edit_distance_join.ed_join_part", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "py_stringsimjoin.apply_rf.edit_distance_join")) {
      if (unlikely(PyDict_SetItemString(modules, "py_stringsimjoin.apply_rf.edit_distance_join", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("ed_join", (void (*)(void))__pyx_f_16py_stringsimjoin_8apply_rf_18edit_distance_join_ed_join, "std::pair<std::vector<std::pair<int,int> > ,std::vector<double> >  (std::vector<std::vector<int> >  &, std::vector<std::vector<int> >  &, int, double, std::vector<std::string>  &, std::vector<std::string>  &, int, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  /*--- Type init code ---*/
  /*--- Type import code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init py_stringsimjoin.apply_rf.edit_distance_join", 0, __pyx_lineno, __pyx_filename);
    }
