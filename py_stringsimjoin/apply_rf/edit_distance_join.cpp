...
static std::vector<std::pair<int,int> >  __pyx_f_16py_stringsimjoin_8apply_rf_18edit_distance_join_ed_join(std::vector<std::vector<int> >  &__pyx_v_ltokens, std::vector<std::vector<int> >  &__pyx_v_rtokens, int __pyx_v_qval, double __pyx_v_threshold, std::vector<std::string>  &__pyx_v_lstrings, std::vector<std::string>  &__pyx_v_rstrings, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
                            __pyx_f_16py_stringsimjoin_8apply_rf_18edit_distance_join_ed_join_part((__pyx_v_partitions[__pyx_v_i]), __pyx_v_ltokens, __pyx_v_rtokens, __pyx_v_qval, __pyx_v_threshold, __pyx_v_index, __pyx_v_lstrings, __pyx_v_rstrings, (__pyx_v_output_pairs[__pyx_v_i]));
                        }
                    }
                }
            }
...
static void __pyx_f_16py_stringsimjoin_8apply_rf_18edit_distance_join_ed_join_part(std::pair<int,int>  __pyx_v_partition, CYTHON_UNUSED std::vector<std::vector<int> >  &__pyx_v_ltokens, std::vector<std::vector<int> >  &__pyx_v_rtokens, int __pyx_v_qval, double __pyx_v_threshold, InvertedIndex &__pyx_v_index, std::vector<std::string>  &__pyx_v_lstrings, std::vector<std::string>  &__pyx_v_rstrings, std::vector<std::pair<int,int> >  &__pyx_v_output_pairs) {
  ...
  int __pyx_t_7;
  std::set<int> ::iterator __pyx_t_8;
  int __pyx_t_9;
  int __pyx_t_10;
 ...
 * 
 */
      __pyx_t_6 = &(__pyx_v_index.index[(__pyx_v_tokens[__pyx_v_j])]);
 ...
 */
    __pyx_t_8 = __pyx_v_candidates.begin();
    for (;;) {
      if (!(__pyx_t_8 != __pyx_v_candidates.end())) break;
      __pyx_t_3 = *__pyx_t_8;
      ++__pyx_t_8;
 ...
 */
      ...
      __pyx_t_9 = ((__pyx_v_m - __pyx_v_threshold) <= __pyx_t_3);
      if (__pyx_t_9) {
        __pyx_t_9 = (__pyx_t_3 <= (__pyx_v_m + __pyx_v_threshold));
      }
...
#endif
{
  ...
  if (__Pyx_ExportFunction("ed_join", (void (*)(void))__pyx_f_16py_stringsimjoin_8apply_rf_18edit_distance_join_ed_join, "std::vector<std::pair<int,int> >  (std::vector<std::vector<int> >  &, std::vector<std::vector<int> >  &, int, double, std::vector<std::string>  &, std::vector<std::string>  &, int __pyx_skip_dispatch)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  /*--- Type import code ---*/
