...
setup(ext_modules = cythonize([
    ...
    Extension("overlap_coefficient_join", sources=["overlap_coefficient_join.pyx"], language="c++",
              extra_compile_args = ["-O3", "-ffast-math", "-march=native", "-fopenmp"],
              extra_link_args=['-fopenmp']),
    Extension("edit_distance_join", sources=["edit_distance_join.pyx"], language="c++",
              extra_compile_args = ["-O3", "-ffast-math", "-march=native", "-fopenmp"],
              extra_link_args=['-fopenmp']),  
