...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++", 
        "name": "execute_feature_node", 
        "sources": [
            "execute_feature_node.pyx", 
            "predicatecpp.cpp"
        ]
    }, 
    "module_name": "execute_feature_node"
}
END: Cython Metadata */
...
#define __PYX_HAVE__py_stringsimjoin__apply_rf__execute_feature_node
#define __PYX_HAVE_API__py_stringsimjoin__apply_rf__execute_feature_node
#include <vector>
#include "ios"
#include "new"
#include "stdexcept"
...
#define __Pyx_MODULE_NAME "py_stringsimjoin.apply_rf.execute_feature_node"
int __pyx_module_is_main_py_stringsimjoin__apply_rf__execute_feature_node = 0;

/* Implementation of 'py_stringsimjoin.apply_rf.execute_feature_node' */
...
/* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":16
...
static std::vector<double>  __pyx_f_16py_stringsimjoin_8apply_rf_20execute_feature_node_execute_feature_node(std::vector<std::pair<int,int> >  &__pyx_v_candset, std::vector<int>  &__pyx_v_pair_ids, bool __pyx_v_top_level_node, std::vector<std::string>  &__pyx_v_lstrings, std::vector<std::string>  &__pyx_v_rstrings, Predicatecpp __pyx_v_predicate, CYTHON_UNUSED int __pyx_v_n_jobs, std::string const &__pyx_v_working_dir, bool __pyx_v_use_cache, std::map<std::string,std::vector<std::vector<int> > >  &__pyx_v_ltokens_cache, std::map<std::string,std::vector<std::vector<int> > >  &__pyx_v_rtokens_cache) {
  ...
  /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":28
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":29
 * 
 *     if predicate.is_tok_sim_measure:
 *         if use_cache:             # <<<<<<<<<<<<<<
 *             ltokens = ltokens_cache[predicate.tokenizer_type]
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":30
 *     if predicate.is_tok_sim_measure:
 *         if use_cache:
 *             ltokens = ltokens_cache[predicate.tokenizer_type]             # <<<<<<<<<<<<<<
 *             rtokens = rtokens_cache[predicate.tokenizer_type]
 ...
 */
      ...
      /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":31
 *         if use_cache:
 *             ltokens = ltokens_cache[predicate.tokenizer_type]
 *             rtokens = rtokens_cache[predicate.tokenizer_type]             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":33
 *             rtokens = rtokens_cache[predicate.tokenizer_type]
 *         else:
 *             load_tok(predicate.tokenizer_type, working_dir, ltokens, rtokens)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    /*else*/ {
      __pyx_t_2 = __pyx_convert_PyBytes_string_to_py_std__in_string(__pyx_v_predicate.tokenizer_type); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 33, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_3 = __pyx_convert_PyBytes_string_to_py_std__in_string(__pyx_v_working_dir); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 33, __pyx_L1_error)
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":37
 *     cdef int n, sim_type, i
 * 
 *     if top_level_node:             # <<<<<<<<<<<<<<
 *         n = candset.size()
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":38
 * 
 *     if top_level_node:
 *         n = candset.size()             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":40
 *         n = candset.size()
 *     else:
 *         n = pair_ids.size()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":42
 *         n = pair_ids.size()
 * 
 *     cdef vector[double] feature_values = xrange(0, n)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_n); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_4 = __pyx_convert_vector_from_py_double(__pyx_t_3); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_feature_values = __pyx_t_4;

  /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":44
 *     cdef vector[double] feature_values = xrange(0, n)
 * 
 *     sim_type = get_sim_type(predicate.sim_measure_type)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":49
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":50
 * 
 *     if predicate.is_tok_sim_measure:
 *         token_sim_fn = get_token_sim_function(sim_type)             # <<<<<<<<<<<<<<
 *         if top_level_node:
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":51
 *     if predicate.is_tok_sim_measure:
 *         token_sim_fn = get_token_sim_function(sim_type)
 *         if top_level_node:             # <<<<<<<<<<<<<<
 *             for i in prange(n, nogil=True, num_threads=n_jobs):
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":52
 *         token_sim_fn = get_token_sim_function(sim_type)
 *         if top_level_node:
 *             for i in prange(n, nogil=True, num_threads=n_jobs):             # <<<<<<<<<<<<<<
 *                 cand = candset[i]
                        ...
                        for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_7; __pyx_t_6++){
                            {
                                ...
                                /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":53
 *         if top_level_node:
 *             for i in prange(n, nogil=True, num_threads=n_jobs):
 *                 cand = candset[i]             # <<<<<<<<<<<<<<
 *                 feature_values[i] = token_sim_fn(ltokens[cand.first],
 ...
 */
                                ...
                                /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":54
 *             for i in prange(n, nogil=True, num_threads=n_jobs):
 *                 cand = candset[i]
 *                 feature_values[i] = token_sim_fn(ltokens[cand.first],             # <<<<<<<<<<<<<<
 *                                                  rtokens[cand.second])
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":57
 *                                                  rtokens[cand.second])
 *         else:
 *             for i in prange(n, nogil=True, num_threads=n_jobs):             # <<<<<<<<<<<<<<
                        ...
                        for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6++){
                            {
                                ...
                                /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":58
 *         else:
 *             for i in prange(n, nogil=True, num_threads=n_jobs):
 *                 cand = candset[pair_ids[i]]             # <<<<<<<<<<<<<<
 *                 feature_values[i] = token_sim_fn(ltokens[cand.first],
 ...
 */
                                ...
                                /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":59
 *             for i in prange(n, nogil=True, num_threads=n_jobs):
 *                 cand = candset[pair_ids[i]]
 *                 feature_values[i] = token_sim_fn(ltokens[cand.first],             # <<<<<<<<<<<<<<
 *                                                  rtokens[cand.second])
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":62
 *                                                  rtokens[cand.second])
 *     else:
 ...
 */
  /*else*/ {
    ...
    /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":63
 *     else:
 *         str_sim_fn = get_str_sim_function(sim_type)
 *         if top_level_node:             # <<<<<<<<<<<<<<
 *             for i in prange(n, nogil=True, num_threads=n_jobs):
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":64
 *         str_sim_fn = get_str_sim_function(sim_type)
 *         if top_level_node:
 *             for i in prange(n, nogil=True, num_threads=n_jobs):             # <<<<<<<<<<<<<<
 *                 cand = candset[i]
                        ...
                        for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_7; __pyx_t_6++){
                            {
                                ...
                                /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":65
 *         if top_level_node:
 *             for i in prange(n, nogil=True, num_threads=n_jobs):
 *                 cand = candset[i]             # <<<<<<<<<<<<<<
 *                 feature_values[i] = str_sim_fn(lstrings[cand.first],
 ...
 */
                                ...
                                /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":66
 *             for i in prange(n, nogil=True, num_threads=n_jobs):
 *                 cand = candset[i]
 *                 feature_values[i] = str_sim_fn(lstrings[cand.first],             # <<<<<<<<<<<<<<
 *                                                rstrings[cand.second])
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":69
 *                                                rstrings[cand.second])
 *         else:
 *             for i in prange(n, nogil=True, num_threads=n_jobs):             # <<<<<<<<<<<<<<
 *                 cand = candset[pair_ids[i]]
                        ...
                        for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6++){
                            {
                                ...
                                /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":70
 *         else:
 *             for i in prange(n, nogil=True, num_threads=n_jobs):
 *                 cand = candset[pair_ids[i]]             # <<<<<<<<<<<<<<
 *                 feature_values[i] = str_sim_fn(lstrings[cand.first],
 ...
 */
                                ...
                                /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":71
 *             for i in prange(n, nogil=True, num_threads=n_jobs):
 *                 cand = candset[pair_ids[i]]
 *                 feature_values[i] = str_sim_fn(lstrings[cand.first],             # <<<<<<<<<<<<<<
 *                                                rstrings[cand.second])
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":73
 *                 feature_values[i] = str_sim_fn(lstrings[cand.first],
 *                                                rstrings[cand.second])
 *     return feature_values             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_WriteUnraisable("py_stringsimjoin.apply_rf.execute_feature_node.execute_feature_node", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
...
static int __pyx_pymod_exec_execute_feature_node(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_execute_feature_node},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initexecute_feature_node(void); /*proto*/
PyMODINIT_FUNC initexecute_feature_node(void)
#else
PyMODINIT_FUNC PyInit_execute_feature_node(void); /*proto*/
PyMODINIT_FUNC PyInit_execute_feature_node(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_execute_feature_node(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_execute_feature_node(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("execute_feature_node", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_py_stringsimjoin__apply_rf__execute_feature_node) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "py_stringsimjoin.apply_rf.execute_feature_node")) {
      if (unlikely(PyDict_SetItemString(modules, "py_stringsimjoin.apply_rf.execute_feature_node", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("execute_feature_node", (void (*)(void))__pyx_f_16py_stringsimjoin_8apply_rf_20execute_feature_node_execute_feature_node, "std::vector<double>  (std::vector<std::pair<int,int> >  &, std::vector<int>  &, bool, std::vector<std::string>  &, std::vector<std::string>  &, Predicatecpp, int, std::string const &, bool, std::map<std::string,std::vector<std::vector<int> > >  &, std::map<std::string,std::vector<std::vector<int> > >  &)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  /*--- Type init code ---*/
  /*--- Type import code ---*/
  ...
  /* "py_stringsimjoin/apply_rf/execute_feature_node.pyx":2
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init py_stringsimjoin.apply_rf.execute_feature_node", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init py_stringsimjoin.apply_rf.execute_feature_node");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
