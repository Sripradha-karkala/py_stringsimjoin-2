...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++", 
        "name": "execute_filter_node", 
        "sources": [
            "execute_filter_node.pyx", 
            "predicatecpp.cpp"
        ]
    }, 
    "module_name": "execute_filter_node"
}
END: Cython Metadata */
 ...
 */
    /*else*/ {
      __pyx_t_2 = __pyx_convert_PyBytes_string_to_py_std__in_string(__pyx_v_predicate.tokenizer_type); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 34, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_3 = __pyx_convert_PyBytes_string_to_py_std__in_string(__pyx_v_working_dir); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 34, __pyx_L1_error)
      ...
      /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":35
 *         else:
 *             load_tok(predicate.tokenizer_type, working_dir, ltokens, rtokens)
 *             print 'loaded tok: ', ltokens.size(), rtokens.size()             # <<<<<<<<<<<<<<
 *     cdef vector[pair[int, int]] partitions
 ...
 */
      __pyx_t_3 = __Pyx_PyInt_FromSize_t(__pyx_v_ltokens.size()); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_2 = __Pyx_PyInt_FromSize_t(__pyx_v_rtokens.size()); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_4 = PyTuple_New(3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_INCREF(__pyx_kp_s_loaded_tok);
      __Pyx_GIVEREF(__pyx_kp_s_loaded_tok);
      PyTuple_SET_ITEM(__pyx_t_4, 0, __pyx_kp_s_loaded_tok);
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":39
 *     cdef vector[int] final_output_pairs, part_pairs
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":42
 * 
 *     if top_level_node:
 *         n = candset.size()             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":44
 *         n = candset.size()
 *     else:
 *         n = pair_ids.size()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":46
 *         n = pair_ids.size()
 * 
 *     partition_size = <int>(<float> n / <float> n_jobs)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyInt_From_int(((int)(((float)__pyx_v_n) / ((float)__pyx_v_n_jobs)))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 46, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_v_partition_size = __pyx_t_4;
  __pyx_t_4 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_2 = PyNumber_Add(__pyx_t_4, __pyx_v_partition_size); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 49, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":52
 *         if end > n or i == n_jobs - 1:
 *             end = n
 *         partitions.push_back(pair[int, int](start, end))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":55
 * 
 *         start = end
 *         output_pairs.push_back(vector[int]())             # <<<<<<<<<<<<<<
 * 
 ...
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_parallen_begin) < 0) __PYX_ERR(0, 61, __pyx_L1_error)
                    ...
                    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_7; __pyx_t_6++){
                        {
                            ...
                            /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":63
 *     print 'parallen begin'
 *     for i in prange(n_jobs, nogil=True):
 *         execute_filter_node_part(partitions[i], candset, pair_ids, top_level_node,             # <<<<<<<<<<<<<<
 *                                   ltokens, rtokens, lstrings, rstrings,
 ...
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_parallen_end) < 0) __PYX_ERR(0, 67, __pyx_L1_error)
 ...
 */
  ...
  for (;;) {
    ...
    /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":69
 *     print 'parallen end'
 *     for part_pairs in output_pairs:
 *         final_output_pairs.insert(final_output_pairs.end(), part_pairs.begin(), part_pairs.end())             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":71
 *         final_output_pairs.insert(final_output_pairs.end(), part_pairs.begin(), part_pairs.end())
 * 
 *     return final_output_pairs             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_WriteUnraisable("py_stringsimjoin.apply_rf.execute_filter_node.execute_filter_node", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
...
/* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":73
 *     return final_output_pairs
 * 
 * cdef void execute_filter_node_part(pair[int, int] partition,             # <<<<<<<<<<<<<<
...
static void __pyx_f_16py_stringsimjoin_8apply_rf_19execute_filter_node_execute_filter_node_part(std::pair<int,int>  __pyx_v_partition, std::vector<std::pair<int,int> >  &__pyx_v_candset, std::vector<int>  &__pyx_v_pair_ids, bool __pyx_v_top_level_node, std::vector<std::vector<int> >  &__pyx_v_ltokens, std::vector<std::vector<int> >  &__pyx_v_rtokens, std::vector<std::string>  &__pyx_v_lstrings, std::vector<std::string>  &__pyx_v_rstrings, Predicatecpp &__pyx_v_predicate, int __pyx_v_sim_type, int __pyx_v_comp_type, std::vector<int>  &__pyx_v_output_pairs) {
  ...
  /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":90
 ...
 */
        ...
        /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":97
 *             for i in range(partition.first, partition.second):
 *                 cand  = candset[i]
 *                 if comp_fn(token_sim_fn(ltokens[cand.first], rtokens[cand.second]),             # <<<<<<<<<<<<<<
 *                            predicate.threshold):
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":99
 *                 if comp_fn(token_sim_fn(ltokens[cand.first], rtokens[cand.second]),
 *                            predicate.threshold):
 *                     output_pairs.push_back(i)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        ...
        /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":103
 *             for i in range(partition.first, partition.second):
 *                 cand  = candset[pair_ids[i]]
 *                 if comp_fn(token_sim_fn(ltokens[cand.first], rtokens[cand.second]),             # <<<<<<<<<<<<<<
 *                            predicate.threshold):
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":105
 *                 if comp_fn(token_sim_fn(ltokens[cand.first], rtokens[cand.second]),
 *                            predicate.threshold):
 *                     output_pairs.push_back(pair_ids[i])             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
        ...
        /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":111
 *             for i in range(partition.first, partition.second):
 *                 cand  = candset[i]
 *                 if comp_fn(str_sim_fn(lstrings[cand.first], rstrings[cand.second]),             # <<<<<<<<<<<<<<
 *                            predicate.threshold):
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":113
 *                 if comp_fn(str_sim_fn(lstrings[cand.first], rstrings[cand.second]),
 *                            predicate.threshold):
 *                     output_pairs.push_back(i)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        ...
        /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":117
 *             for i in range(partition.first, partition.second):
 *                 cand  = candset[pair_ids[i]]
 *                 if comp_fn(str_sim_fn(lstrings[cand.first], rstrings[cand.second]),             # <<<<<<<<<<<<<<
 *                            predicate.threshold):
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":119
 *                 if comp_fn(str_sim_fn(lstrings[cand.first], rstrings[cand.second]),
 *                            predicate.threshold):
 *                     output_pairs.push_back(pair_ids[i])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("py_stringsimjoin.apply_rf.execute_filter_node.execute_filter_node_part", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":122
 * 
 * 
...
static std::vector<int>  __pyx_f_16py_stringsimjoin_8apply_rf_19execute_filter_node_execute_filters(std::vector<std::pair<int,int> >  &__pyx_v_candset, std::vector<int>  &__pyx_v_pair_ids, bool __pyx_v_top_level_node, std::vector<std::string>  &__pyx_v_lstrings, std::vector<std::string>  &__pyx_v_rstrings, std::vector<Predicatecpp>  __pyx_v_predicates, int __pyx_v_n_jobs, std::string const &__pyx_v_working_dir, bool __pyx_v_use_cache, std::map<std::string,std::vector<std::vector<int> > >  &__pyx_v_ltokens_cache, std::map<std::string,std::vector<std::vector<int> > >  &__pyx_v_rtokens_cache) {
  ...
  std::vector<Predicatecpp> ::size_type __pyx_t_10;
 ...
 */
      ...
      /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":136
 *         if use_cache:
 *             ltokens = ltokens_cache[predicates[0].tokenizer_type]
 *             rtokens = rtokens_cache[predicates[0].tokenizer_type]             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":138
 *             rtokens = rtokens_cache[predicates[0].tokenizer_type]
 *         else:
 *             load_tok(predicates[0].tokenizer_type, working_dir, ltokens, rtokens)             # <<<<<<<<<<<<<<
 *     cdef vector[pair[int, int]] partitions
 ...
 */
    /*else*/ {
      __pyx_t_2 = __pyx_convert_PyBytes_string_to_py_std__in_string((__pyx_v_predicates[0]).tokenizer_type); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 138, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_3 = __pyx_convert_PyBytes_string_to_py_std__in_string(__pyx_v_working_dir); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 138, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_f_16py_stringsimjoin_8apply_rf_10tokenizers_load_tok(__pyx_t_2, __pyx_t_3, __pyx_v_ltokens, __pyx_v_rtokens, 0);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":142
 *     cdef vector[int] final_output_pairs, part_pairs
 *     cdef vector[vector[int]] output_pairs
 *     cdef int n, start=0, end, i             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":145
 * 
 *     if top_level_node:
 *         n = candset.size()             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":147
 *         n = candset.size()
 *     else:
 *         n = pair_ids.size()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":149
 *         n = pair_ids.size()
 * 
 *     partition_size = <int>(<float> n / <float> n_jobs)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyInt_From_int(((int)(((float)__pyx_v_n) / ((float)__pyx_v_n_jobs)))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 149, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 *             end = n
 */
    __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_start); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 152, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_2 = PyNumber_Add(__pyx_t_3, __pyx_v_partition_size); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 152, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_t_2); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 152, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":155
 *         if end > n or i == n_jobs - 1:
 *             end = n
 *         partitions.push_back(pair[int, int](start, end))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":158
 * 
 *         start = end
 *         output_pairs.push_back(vector[int]())             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":164
 *     for i in range(predicates.size()):
 *         sim_types.push_back(get_sim_type(predicates[i].sim_measure_type))
 *         comp_types.push_back(get_comp_type(predicates[i].comp_op))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_parallen_begin) < 0) __PYX_ERR(0, 166, __pyx_L1_error)
                    ...
                    for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_6; __pyx_t_5++){
                        {
                            ...
                            /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":168
 *     print 'parallen begin'
 *     for i in prange(n_jobs, nogil=True):
 *         execute_filters_part(partitions[i], candset, pair_ids, top_level_node,             # <<<<<<<<<<<<<<
 *                              ltokens, rtokens, lstrings, rstrings,
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":171
 *                              ltokens, rtokens, lstrings, rstrings,
 *                              predicates, sim_types, comp_types, output_pairs[i])
 *     print 'parallen end'             # <<<<<<<<<<<<<<
 * 
 *     for i in range(n_jobs):
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_parallen_end) < 0) __PYX_ERR(0, 171, __pyx_L1_error)
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_6; __pyx_t_5+=1) {
    ...
    /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":174
 * 
 *     for i in range(n_jobs):
 *         final_output_pairs.insert(final_output_pairs.end(),             # <<<<<<<<<<<<<<
 *                                   output_pairs[i].begin(),
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":178
 *                                   output_pairs[i].end())
 * 
 *     return final_output_pairs             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_WriteUnraisable("py_stringsimjoin.apply_rf.execute_filter_node.execute_filters", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __Pyx_pretend_to_initialize(&__pyx_r);
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_partition_size);
  __Pyx_RefNannyFinishContext();
...
/* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":180
 *     return final_output_pairs
 * 
 * cdef void execute_filters_part(pair[int, int] partition,             # <<<<<<<<<<<<<<
 *                                    vector[pair[int, int]]& candset,
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":201
 *     for i in range(sim_types.size()):
 *         token_sim_fns.push_back(get_overlap_sim_function(sim_types[i]))
 *         comp_fns.push_back(get_comparison_function(comp_types[i]))             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_1; __pyx_t_5+=1) {
        ...
        /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":211
 *             flag = True
 *             for j in xrange(sim_types.size()):
 *                 if not comp_fns[j](token_sim_fns[j](size1, size2, overlap_score),             # <<<<<<<<<<<<<<
 *                                    predicates[j].threshold):
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":216
 *                     break
 *             if flag:
 *                 output_pairs.push_back(i)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
      ...
      for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_1; __pyx_t_5+=1) {
        ...
        /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":225
 *             flag = True
 *             for j in xrange(sim_types.size()):
 *                 if not comp_fns[j](token_sim_fns[j](size1, size2, overlap_score),             # <<<<<<<<<<<<<<
 *                                    predicates[j].threshold):
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "py_stringsimjoin/apply_rf/execute_filter_node.pyx":230
 *                     break
 *             if flag:
 *                 output_pairs.push_back(i)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("py_stringsimjoin.apply_rf.execute_filter_node.execute_filters_part", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}
...
static int __pyx_pymod_exec_execute_filter_node(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_execute_filter_node},
  {0, NULL}
};
#endif
...
static int __Pyx_InitCachedBuiltins(void) {
  ...
  #if PY_MAJOR_VERSION >= 3
  __pyx_builtin_xrange = __Pyx_GetBuiltinName(__pyx_n_s_range); if (!__pyx_builtin_xrange) __PYX_ERR(0, 210, __pyx_L1_error)
  #else
  __pyx_builtin_xrange = __Pyx_GetBuiltinName(__pyx_n_s_xrange); if (!__pyx_builtin_xrange) __PYX_ERR(0, 210, __pyx_L1_error)
  #endif
  return 0;
  __pyx_L1_error:;
  return -1;
...
static int __pyx_pymod_exec_execute_filter_node(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "py_stringsimjoin.apply_rf.execute_filter_node")) {
      if (unlikely(PyDict_SetItemString(modules, "py_stringsimjoin.apply_rf.execute_filter_node", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("execute_filter_node", (void (*)(void))__pyx_f_16py_stringsimjoin_8apply_rf_19execute_filter_node_execute_filter_node, "std::vector<int>  (std::vector<std::pair<int,int> >  &, std::vector<int>  &, bool, std::vector<std::string>  &, std::vector<std::string>  &, Predicatecpp, int, std::string const &, bool, std::map<std::string,std::vector<std::vector<int> > >  &, std::map<std::string,std::vector<std::vector<int> > >  &)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ExportFunction("execute_filters", (void (*)(void))__pyx_f_16py_stringsimjoin_8apply_rf_19execute_filter_node_execute_filters, "std::vector<int>  (std::vector<std::pair<int,int> >  &, std::vector<int>  &, bool, std::vector<std::string>  &, std::vector<std::string>  &, std::vector<Predicatecpp> , int, std::string const &, bool, std::map<std::string,std::vector<std::vector<int> > >  &, std::map<std::string,std::vector<std::vector<int> > >  &)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  /*--- Type init code ---*/
  /*--- Type import code ---*/
  ...
  if (__Pyx_ImportFunction(__pyx_t_2, "get_sim_function_str", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_5utils_get_sim_function_str, "__pyx_t_16py_stringsimjoin_8apply_rf_5utils_simfnptr_str (int const )") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  ...
  if (__Pyx_ImportFunction(__pyx_t_2, "get_tok_type", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_5utils_get_tok_type, "int (std::string const &)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  Py_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __Pyx_ImportModule("py_stringsimjoin.apply_rf.sim_functions"); if (!__pyx_t_3) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_3, "overlap", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_13sim_functions_overlap, "double (std::vector<int>  const &, std::vector<int>  const &)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init py_stringsimjoin.apply_rf.execute_filter_node", 0, __pyx_lineno, __pyx_filename);
    }
